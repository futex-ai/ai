//! Conversation roles, retained messages, and message constructors.

use serde::{Deserialize, Serialize};

use crate::ToolCall;

use super::content::ConversationContentPart;
use super::provider_context::ProviderConversationItem;
