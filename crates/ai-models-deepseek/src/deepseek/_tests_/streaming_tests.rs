//! DeepSeek streaming request and buffered-parity tests.
...
async fn streams_rich_deltas_with_usage_and_matches_buffered_parser() {
    ...
    let model = DeepSeekModel::new(http_client, "deepseek-key");
    ...
    .expect("buffered DeepSeek response should parse");
