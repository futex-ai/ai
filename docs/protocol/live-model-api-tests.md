...
over that streaming path by its existing catalog test; Anthropic is the first
such provider. Deterministic transport tests in provider crates remain
responsible for detailed event and wire behavior.
