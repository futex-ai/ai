...
## Milestone 9: Final Review Follow-Up

Close the remaining credential-leak paths found by the final design review
and finish the test-layout cleanup. At the end of this milestone, redaction
